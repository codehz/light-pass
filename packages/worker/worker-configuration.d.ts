/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7097aa34479eb66d2adedeedd7fc8308)
// Runtime types generated with workerd@1.20251217.0 2025-07-22 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Backend" | "Looper";
	}
	interface Env {
		...
		LOOPER: DurableObjectNamespace<import("./src/index").Looper>;
		VERIFY: Workflow<Parameters<import("./src/index").VerifyUser['run']>[0]['payload']>;
	}
}
